...
const sections: Section[] = [
  ...
  },
  {
    ...
    features: [
      ...
      'הצגת מי הזמין כל משתמש, תאריך יצירה וכניסה אחרונה',
  ...
  },
  {
    ...
    features: [
      ...
      'סינון חומרים לפי סטטוס: תקפים, פגי תוקף, עומדים לפוג (30 יום)',
      'מחיקה אוטומטית יומית של חומרים שפג תוקפם (כולל קבצים מהאחסון)',
      'ניתן לעדכן תפוגה ורישיון דרך עריכת החומר',
    ],
    faq: [
      { question: 'מה קורה כשחומר פג תוקף?', answer: 'חומרים שפג תוקפם נמחקים אוטומטית מהמערכת ומהאחסון פעם ביום. ההפעלה מתבצעת באמצעות Cron Job ומתועדת ביומן הפעילות.' },
      { question: 'איך מסננים חומרים לפי תפוגה?', answer: 'בספריית החומרים, השתמשו בפילטר "תפוגה". ניתן לראות חומרים תקפים, חומרים שפגו, או חומרים שעומדים לפוג ב-30 הימים הקרובים.' },
    ],
  },
  {
    id: 'naming',
